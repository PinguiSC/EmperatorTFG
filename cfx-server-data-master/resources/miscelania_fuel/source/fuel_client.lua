...
AddEventHandler('fuel:startFuelUpTick', function(pumpObject, ped, vehicle)
	...
	while isFueling do
		...
		currentCost = currentCost + extraCost * 6
	...
	Citizen.CreateThread(function()
		while true do
			...
			if displayHud then
				...
				DrawAdvancedText(0.130 - x, 0.82 - y, 0.005, 0.0028, 0.6, kmh, 255, 255, 255, 255, 6, 1)
				DrawAdvancedText(0.2195 - x, 0.82 - y, 0.005, 0.0028, 0.6, fuel, 255, 255, 255, 255, 6, 1)
				DrawAdvancedText(0.148 - x, 0.8265 - y, 0.005, 0.0028, 0.4, "km/h              Fuel", 255, 255, 255, 255, 6, 1)
			else
				Citizen.Wait(750)
			end
		end
