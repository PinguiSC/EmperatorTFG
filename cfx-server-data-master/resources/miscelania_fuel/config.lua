...
Config.Strings = {
	ExitVehicle = "Sal para rellenar la gasolina",
	EToRefuel = "Pulsa ~g~E ~w~para recargar el vehiculo",
	JerryCanEmpty = "El bidon esta vacio",
	FullTank = "El tanque esta lleno",
	PurchaseJerryCan = "Pulsa ~g~E ~w~para comprar un bidon por ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Pulsa ~g~E ~w~para cancelar recarga",
	CancelFuelingJerryCan = "Pulsa ~g~E ~w~para cancelar regarga",
	NotEnoughCash = "No tienes suficiente dinero",
	RefillJerryCan = "Pulsa  ~g~E ~w~ para rellenar el bidon",
	NotEnoughCashJerryCan = "No tienes suficiente efectivo para rellenar el bidon",
	JerryCanFull = "Garrafa llena"
}
